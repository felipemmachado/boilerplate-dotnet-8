...
{
    /// <inheritdoc />
    public partial class Initials_Tables_v100 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Roles = table.Column<string[]>(type: "string[]", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("46c807d5-08df-4cd0-a4ae-d51703ce8a4d"), new DateTime(2023, 10, 10, 12, 0, 0, 0, DateTimeKind.Utc), null, null, "admin@gmail.com", null, null, "Administardor", "k8NnNwr8ibspoj8+LbYV6A==.Sfw1H6AGYEI9yTNpoHlGuQ1TqxTeUEy1Ow9tBVW1ju8=", new Guid("3bec3b12-26c7-4cd9-875e-f60807c0613c"), true, null, null });
