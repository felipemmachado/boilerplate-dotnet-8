...
public static class ApiResponseMessages
{
    ...
    public const string RequiredEmail = "O e-mail é obrigatório.";
    public const string InvalidEmail = "E-mail inválido.";

    public const string RequiredPassword = "Você tem que digitar uma senha.";
    public const string PasswordsAreNotTheSame = "As senhas não são as mesmas.";

    public const string RequiredName = "O nome é obrigatório";
